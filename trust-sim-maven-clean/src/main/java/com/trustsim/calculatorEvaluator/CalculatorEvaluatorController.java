...
import com.trustsim.evaluator.EvaluatorBaseController;
import com.trustsim.evaluator.GraphTypeEnum;
import com.trustsim.evaluator.SimpleSimulationSettingsPane;
...
public class CalculatorEvaluatorController extends EvaluatorBaseController {
    ...
    private final String sqlTableName = "agentSystemsCalculator";
    ...
    protected void refreshEvaluatorGraphPane() {
        if (selectedSimulationResult != null) {
            ...
            individualGraphSelectorComboBox.getSelectionModel().selectFirst();
            selectedAllAgentSystemGraph = (GraphDataObj) individualGraphSelectorComboBox.getSelectionModel().getSelectedItem();
        } else {
    ...
    protected void refreshEvaluatorTablePane() {
        ...
        if (selectedSimulationResult != null) {
            ...
            individualTableSelectorComboBox.getSelectionModel().selectFirst();
            selectedAllAgentSystemTable = (TableDataObj) individualTableSelectorComboBox.getSelectionModel().getSelectedItem();
        } else {
            tabPaneParent.setVisible(false);
        }
    }
    ...
    protected void refreshSystemInfoPane() {
        ...
        if (selectedSimulationResult != null) {
            systemInformationContainerHBox.getChildren().add(new SimpleSimulationSettingsPane(selectedSimulationResult));
        }
    }
