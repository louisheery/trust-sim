package com.trustsim.ingestor.view;
...
public class IngestorView {

  private BorderPane view;
  private IngestorController controller;
  private IngestorEngine model;

  public IngestorView(IngestorController ingestorController, IngestorEngine ingestorEngine) {

    controller = ingestorController;
    model = ingestorEngine;
