package com.trustsim.synthesiser.view;
...
public class SynthesiserView {

  private BorderPane view;
  private SynthesiserController controller;
  private SynthesiserEngine model;

  public SynthesiserView(SynthesiserController synthesiserController, SynthesiserEngine synthesiserEngine) {

    controller = synthesiserController;
    model = synthesiserEngine;
